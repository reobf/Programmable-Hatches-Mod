...
public class MUITransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (!done) if (name.equals("com.gtnewhorizons.modularui.common.internal.wrapper.ModularUIContainer")) {
            done = true;
    ...
    static class TheNode extends MethodNode {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (arr.size() <= 2) if (owner.equals("com/gtnewhorizons/modularui/common/internal/wrapper/BaseSlot")
                && name.equals("getShiftClickPriority")) {
        ...
        public void visitJumpInsn(int opcode, Label label) {
            ...
            if (arr.size() == 2 && !done) {
                ...
                super.visitMethodInsn(Opcodes.INVOKESTATIC, "reobf/proghatches/main/asm/Util", "isSameGroup"
                    ...
                    ,
                    "(Lcom/gtnewhorizons/modularui/common/internal/wrapper/BaseSlot;Lcom/gtnewhorizons/modularui/common/internal/wrapper/BaseSlot;)Z",
                    false);
