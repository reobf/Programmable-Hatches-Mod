...
public class ItemGTRedstoneCard extends Item implements li.cil.oc.api.driver.item.HostAware {
    ...
    public class RedstoneEnv implements ManagedEnvironment {
        ...
        @Callback(
            doc = "setWireless(frequency:number,signal:number[,isPublic:boolean]) --s et GT wireless redstone, 'isPublic' defaults to true",
            direct = false)
        ...
        public Object[] getOwnerUUID(final Context context, final Arguments args) {
            ...
            return new Object[] { Optional.ofNullable(ItemGTRedstoneCard.this.getUUID(stack))
                .map(Object::toString)
                .orElse(null) };
        }
