...
public class PartEUP2PInterface extends PartP2PTunnelStatic<PartEUP2PInterface>
        implements IGridTickable, IStorageMonitorable, IInventoryDestination, IDualHost, ISidedInventory,
        IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost, IInterfaceHost,IPartGT5Power,IGuiProvidingPart,IDrain {
    ...
    public boolean redstone() {int power;//=0;
            ...
            if (b != null ) {
                ...
                power = Math
                        .max(power, b.isProvidingWeakPower(this.getTile().getWorldObj(), x, y, z, srcSide));
                return power>0;
            } else {
                return false;
            }
	...
	public boolean isP2POut(){return this.isOutput();}
