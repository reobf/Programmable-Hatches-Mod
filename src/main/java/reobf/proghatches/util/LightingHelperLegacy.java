/*
 * LightingHelperLegacy - Derived and adapted from @Mineshopper / carpentersblocks Copyright (c) 2013-2021. This library is
...
public class LightingHelperLegacy {
     ...
     */
    public LightingHelperLegacy(RenderBlocks renderBlocks) {
     ...
     */
    public LightingHelperLegacy setBrightnessOverride(int brightness) {
        hasBrightnessOverride = true;
        brightnessOverride = brightness;
        return this;
    }

    public LightingHelperLegacy setColorOverride(short[] color) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setColorOverride(int color) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setLightnessOverride(float lightness) {
     ...
     */
    public LightingHelperLegacy setupLighting(Block block, int x, int y, int z, ForgeDirection facing) {
         switch (facing) {
            case DOWN : return setupLightingYNeg(block, x, y, z);
            case UP : return setupLightingYPos(block, x, y, z);
            case NORTH : return setupLightingZNeg(block, x, y, z);
            case SOUTH : return setupLightingZPos(block, x, y, z);
            case WEST : return setupLightingXNeg(block, x, y, z);
            case EAST : return setupLightingXPos(block, x, y, z);
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingXNeg(Block block, int x, int y, int z) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingXPos(Block block, int x, int y, int z) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingYNeg(Block block, int x, int y, int z) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingYPos(Block block, int x, int y, int z) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingZNeg(Block block, int x, int y, int z) {
     ...
     * @return the {@link LightingHelper}
     */
    public LightingHelperLegacy setupLightingZPos(Block block, int x, int y, int z) {
