...
public class DecoyInputBusME extends MTEHatchInputBusME implements IMEHatchOverrided, IDataCopyablePlaceHolder ,IDoNotSleep{
    ...
    // ===== MUI2 =====
    // GT's MTEHatchInputBusME builds its GUI with MUI2, so the MUI1 addUIWidgets() above is dead now.
    // The decoy bus's only GUI element was a refresh button (reserveFirst is toggled with a
