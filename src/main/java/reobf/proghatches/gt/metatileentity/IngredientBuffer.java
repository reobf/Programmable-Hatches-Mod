...
public class IngredientBuffer extends GT_MetaTileEntity_TieredMachineBlock implements IAddUIWidgets{
	...
	public static int get(int tier,int ift0,int ift1){
		...
		if(tier==T0){return ift0;}
		if(tier==T1){return ift1;}
		//throw new RuntimeException();
		return ift0;
	}
	public IngredientBuffer(int aID, /*int aSlot,*/ String aName, String aNameRegional, int aTier, /*int aInvSlotCount,*/
			String[] aDescription) {
		super(aID, aName, aNameRegional, aTier, get(aTier,9,27),
				reobf.proghatches.main.Config
				.get("IB", ImmutableMap.of("item", get(aTier,4,7),"fluid", get(aTier,9,27),"cap", getCapacityPerTank(aTier,0)
						,"int format","#,###"
						))
...
public boolean isFacingValid(ForgeDirection facing) {
	...
	public boolean isAccessAllowed(EntityPlayer aPlayer) {
	    ...
	    public ITexture[] getTexture(IGregTechTileEntity aBaseMetaTileEntity, ForgeDirection side, ForgeDirection aFacing,
	        ...
	        try {
	            ...
	            } else 
	            {
	            	...
	            	return new 
	            	ITexture[]{Textures.BlockIcons.MACHINE_CASINGS[mTier][colorIndex + 1]};
	    ...
	    public ITexture[] getTexturesMainFacing(ITexture aBaseTexture) {
	    	ITexture tex=this.mTier==T0
	    	?TextureFactory.of(ItemAndBlockHolder.BUFFER):
	    	TextureFactory.of(ItemAndBlockHolder.LARGE_BUFFER);
	        return new ITexture[] { tex/*aBaseTexture*//*, TextureFactory.of(OVERLAY_INPUT_HATCH_2x2)*/ };
	    }
	    ...
	    public void onPostTick(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
	        ...
	        if (mFluidTransfer&&face!=ForgeDirection.UNKNOWN&&aBaseMetaTileEntity.isServerSide() && aBaseMetaTileEntity.isAllowedToWork() ) {
	            ...
	            if (tTileEntity != null) {
	            	...
	            	FluidStack tDrained = aBaseMetaTileEntity
	                    .drain(aBaseMetaTileEntity.getFrontFacing(), fluid, false);
	                if (tDrained != null) {
	                    ...
	                    if (tFilledAmount > 0) {
	                        ...
	                        tTileEntity.fill(
	                            ...
	                            aBaseMetaTileEntity.drain(aBaseMetaTileEntity.getFrontFacing(), cp, true),
	                            true);
	                    }
	                }}
	            }
	        }
	        if (mItemTransfer&&face!=ForgeDirection.UNKNOWN&&aBaseMetaTileEntity.isServerSide() && aBaseMetaTileEntity.isAllowedToWork() && (aTick & 0x7) == 0) {
	            final IInventory tTileEntity = aBaseMetaTileEntity
	                .getIInventoryAtSide(face);
	            if (tTileEntity != null) {
...
protected boolean isValidMainFacing(ForgeDirection side) {
	...
	return true;//(side.flag & (UP.flag | DOWN.flag | UNKNOWN.flag)) == 0; // Horizontal
}
