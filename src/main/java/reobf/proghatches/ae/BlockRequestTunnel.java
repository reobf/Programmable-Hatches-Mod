...
public class BlockRequestTunnel extends BlockContainer implements IOrientableBlock, INameAndTooltips {
    ...
    public void onBlockPlacedBy(World worldIn, int x, int y, int z, EntityLivingBase placer, ItemStack itemIn) {
        ...
        try {
            ((TileRequestTunnel) worldIn.getTileEntity(x, y, z)).getProxy()
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        IIcon x = null;
        tab = new IIcon[][] { { x, x, a, a, a, a }, { x, x, c, c, c, c }, { c, c, x, x, b, d }, { a, a, x, x, d, b },
            { b, b, d, b, x, x }, { d, d, b, d, x, x }, };
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        ...
        if (te.getUp() == ForgeDirection.UNKNOWN) {
            return fr;
        }
