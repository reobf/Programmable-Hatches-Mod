...
public class AutoDataOrbHatch extends MTEHatchElementalDataOrbHolder {
    ...
    public String[] getDescription() {
        ...
        return descCache == null ? (descCache = reobf.proghatches.main.Config.get("ADOH", ImmutableMap.of()))
            : descCache;
    }
    ...
    public boolean allowPullStack(IGregTechTileEntity aBaseMetaTileEntity, int aIndex, ForgeDirection side,
        ...
        return aIndex < mInventory.length - 1 && ItemList.Tool_DataOrb.isStackEqual(aStack, false, true);
