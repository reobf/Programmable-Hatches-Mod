...
public class CommonProxy {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        GameRegistry.registerItem(
            MyMod.plunger = a.setUnlocalizedName("proghatch_me_plunger")
                .setTextureName("proghatches:plunger"),
        ...
        GameRegistry.registerItem(
            MyMod.book = new ItemBookTutorial().setUnlocalizedName("writtenBook")
        ...
        MyMod.alert = GameRegistry.registerBlock(
            ...
            "proghatches.chunk_loading_alert");
        MyMod.submitter = GameRegistry.registerBlock(
            new BlockCyclicPatternSubmitter(Material.rock),
            ItemBlockTooltip.class,
            "proghatches.submitter",
            new Object[] { "tile.proghatches.submitter.tooltip" });

        MyMod.pstation = GameRegistry.registerBlock(
            new TileWirelessPeripheralStation.Block(),
            TileWirelessPeripheralStation.ItemBlock.class,
            "proghatches.peripheral_station");

        MyMod.reader = GameRegistry.registerBlock(new BlockCardReader(Material.rock), "proghatches.card_reader");
        /*
         * MyMod.occonfigurator = GameRegistry.registerBlock(new BlockGTHatchConfigurator(Material.rock),
         * "proghatches.configurator");
         */

        MyMod.reactorsyncer = GameRegistry.registerBlock(
        ...
        GameRegistry.registerBlock(
            ...
            new Object[] { "" });
        GameRegistry.registerBlock(
            MyMod.autofiller = new BlockAutoFillerMKII(),
            ItemBlockTooltip.class,
            "autofillerMKII",
            new Object[] { "" });
        GameRegistry.registerBlock(
        ...
        GameRegistry.registerItem(
            MyMod.emitterpattern = new ItemEmitterPattern().setUnlocalizedName("proghatches.emitterpattern")
    ...
    private static void a() {
        for (int i = 0; i <= 8; i++) {
            ...
            MyMod.condensers[i] = GameRegistry.registerBlock(
                new BlockCraftingCondenser(i),
                ToolTipAEBaseItemBlock.class,
                "proghatches.craftingdumper." + i);
        }
