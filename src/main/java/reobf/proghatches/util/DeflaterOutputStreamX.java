 ...
 */
public
class DeflaterOutputStreamX extends FilterOutputStream {
    /**
     ...
     * @since 1.7
     */
    public DeflaterOutputStreamX(OutputStream out,
                                Deflater def,
                                int size,
                                boolean syncFlush) {
        super(out);
     ...
     */
    public DeflaterOutputStreamX(OutputStream out, Deflater def, int size) {
     ...
     * @param def the compressor ("deflater")
     */
    public DeflaterOutputStreamX(OutputStream out, Deflater def) {
     ...
     * @since 1.7
     */
    public DeflaterOutputStreamX(OutputStream out, boolean syncFlush) {
        ...
        if (!def.finished()) {
            try{
                ...
                if (usesDefaultDeflater)
                	GZIPOutputStreamX.recycleDeflator(def);
                throw e;
            }
        }
    }
