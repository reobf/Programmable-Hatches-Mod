...
public class IngredientBuffer extends MTETieredMachineBlock implements IAddUIWidgets {
    ...
    public IngredientBuffer(int aID, /* int aSlot, */ String aName, String aNameRegional, int aTier, /*
                                                                                                      * int
                                                                                                      * aInvSlotCount,
                                                                                                      */
        String[] aDescription) {
    ...
    public void onPostTick(IGregTechTileEntity aBaseMetaTileEntity, long aTick) {
        ...
        if (mFluidTransfer && face != ForgeDirection.UNKNOWN
        ...
        if (mItemTransfer && face != ForgeDirection.UNKNOWN
            && aBaseMetaTileEntity.isServerSide()
            && aBaseMetaTileEntity.isAllowedToWork()
            && (aTick & 0x7) == 0) {
