...
public class InterfaceP2PNoFluidData implements AECover.IMemoryCardSensitive, Data, IInterfaceHost, IGridTickable,
    ...
    public class Host implements IPartHost, IActualSideProvider, InterfaceData.DisabledInventory {
        ...
        public TileEntity getTile() {
            // TODO Auto-generated method stub
            return InterfaceP2PNoFluidData.this.getTileEntity();
        }
    ...
    PartP2PInterface duality = new PartP2PInterface(new ItemStack(ItemAndBlockHolder.FLUID_INTERFACE_P2P));
        ...
        if (is != null && is.getItem() instanceof IMemoryCard) {
            ...
            if (newType != null) {
                if (newType.getItem() instanceof IPartItem) {
                    ...
                    if (testPart != null && testPart instanceof PartP2PInterface) {
    ...
    public ItemStack getVisual() {
        ...
        return new ItemStack(MyMod.cover, 1, 34);
    }
