...
public class VoidOutputBus  extends GT_MetaTileEntity_Hatch_OutputBus {
	...
	public VoidOutputBus(int aID, String aName, String aNameRegional, int tier) {
		super(aID, aName, aNameRegional, tier, reobf.proghatches.main.Config.get("VOB",
				ImmutableMap.of()),0
    ...
    itemRenderer.setRenderManager(RenderManager.instance);}
	    ...
	    ItemStack is;
	    public EntityDropParticleFX(World worldIn, double p_i1203_2_, double p_i1203_4_, double p_i1203_6_, ItemStack f)
	    {
...
is=f;
			...
			setParticleIcon(f.getItem().getIcon(f,
					(int) (f.getItem().getRenderPasses(f.getItemDamage())*Math.random()))
	...
	*/ 
	...
	//this.worldObj.spawnParticle("splash", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
	    ...
	    @Override
	    public void renderParticle(Tessellator tessellator, float timeStep, float rotationX, float rotationXZ, float rotationZ,
