...
public class DualInputHatch extends GT_MetaTileEntity_Hatch_InputBus implements IConfigurationCircuitSupport,
    ...
    public ItemStackHandler getInventoryHandler() {
        if (bridge == null) bridge = new InventoryItemHandler(mInventory, this);
        return bridge;
    }
    ...
    public void addUIWidgets(Builder builder, UIBuildContext buildContext) {
        ...
        } else addUIWidgets0(builder, buildContext);
    ...
    public void addFluid(FluidStack aFluid, int aSlot) {
        ...
        if (mStoredFluid[aSlot].getFluid() == null) mStoredFluid[aSlot].setFluid(aFluid.copy());
    }
    ...
    public void onFirstTick(IGregTechTileEntity aBaseMetaTileEntity) {
        /*
         * this.mInventory[this.getCircuitSlot()
     ...
     * boolean prev=disableFilter;
     * super.onScrewdriverRightClick(side, aPlayer, aX, aY, aZ);
     * if(prev==true&&disableFilter==false){
     * GT_Utility
     * .sendChatToPlayer(aPlayer,
     * defaultName(
     * "Filter mode of this hatch might not work well",
     * "过滤模式可能无法正常生效")
     * );
     * }
     * }
    ...
    public boolean versionInsensitiveContainsInput(Object o) {
        ...
        if (mh != null) {
            try {
                Object map;
                return ((map = cache1.get(o.getClass())
                    .invoke(this)) == null) || // this.mRecipeMap==null ||
        ...
        try {
            Class<?> recipeMapClass = this.getClass()
                .getField("mRecipeMap")
                .getType();
            MethodHandle mhr = MethodHandles.lookup()
                .findVirtual(recipeMapClass, "containsInput", MethodType.methodType(boolean.class, o.getClass()));
            cache0.put(o.getClass(), mhr);
            cache1.put(
                o.getClass(),
                MethodHandles.lookup()
                    .findGetter(this.getClass(), "mRecipeMap", recipeMapClass));
