...
public class ItemUpgrades extends Item {
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
        ...
        IntStream
            .range(
                0,
                Integer.valueOf(
                    StatCollector.translateToLocal("item.proghatch.upgrades.tooltips." + p_77624_1_.getItemDamage())))
            .forEach(
                s -> p_77624_3_.add(
                    LangManager
                        .translateToLocal("item.proghatch.upgrades.tooltips." + p_77624_1_.getItemDamage() + "." + s)));
    ...
    public void getSubItems(Item p_150895_1_, CreativeTabs p_150895_2_, List p_150895_3_) {
        ...
        list.forEach(i -> p_150895_3_.add(new ItemStack(p_150895_1_, 1, i)));
    }
