...
public class PriorityFilterInputBusME extends MTEHatchInputBusME
    ...
    public void overridedBehoviour(int minPull) {
        ...
        try {
            ...
            for (final ICellProvider cc : get(st)) {
                ...
                if (cc.getPriority() == filter) for (IMEInventoryHandler l : list) {
        ...
        try {
            ...
            lab: for (final ICellProvider cc : get(st)) {
                ...
                if (cc.getPriority() == filter) for (IMEInventoryHandler l : list) {
                    ...
                    if (ext != null) request.decStackSize(ext.getStackSize());
    ...
    // ===== MUI2 =====
    // GT's MTEHatchInputBusME builds its GUI with MUI2 (the old MUI1 addUIWidgets()/
