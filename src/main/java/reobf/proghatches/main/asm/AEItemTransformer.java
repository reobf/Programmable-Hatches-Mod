...
public class AEItemTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        if ((!done) && name.equals("reobf.proghatches.item.ItemMEPlunger")) {
            done = true;
            ...
            ClassWriter cw = new ClassWriter(ClassWriter.COMPUTE_MAXS | ClassWriter.COMPUTE_FRAMES) {
                ...
                public int newUTF8(String value) {
                    ...
                    if (value.contains("reobf/proghatches/item/DummySuper")) {
                        return super.newUTF8(
                            value.replace(
                                "reobf/proghatches/item/DummySuper",
