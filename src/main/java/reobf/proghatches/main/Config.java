...
public class Config {
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        metaTileEntityOffset = configuration.getInt(
            "MetaTEOffset",
            "ID",
            metaTileEntityOffset,
            14301,
            29999,
        ...
        skipRecipeAdding = configuration.getBoolean(
            "skipRecipeAddition",
            Configuration.CATEGORY_GENERAL,
            skipRecipeAdding,
            "If true, this mod will not add any recipe.");
        appendAddedBy = configuration.getBoolean(
            "appendAddedBy",
            Configuration.CATEGORY_GENERAL,
            appendAddedBy,
        ...
        fastPatternDualInput = configuration.getBoolean(
            "Fast PatternDualInputHatch",
            "Experimental",
            fastPatternDualInput,
    ...
    public static void get(MultiblockTooltipBuilder obj, String key, boolean defaulted) {
        try (InputStream in = (defaulted ? getInputEN : getInput).apply(key)) {
            ...
            for (String str : arr) {
                ...
                MethodType tp = MethodType.fromMethodDescriptorString(
                    ...
                    type + (/*
                             * func.equals("toolTipFinisher") ? "V"
                             * :
                             */ "L" + MultiblockTooltipBuilder.class.getName()
                        .replace(".", "/") + ";")
                ...
                call(
                    ...
                    MethodHandles.lookup()
                        .findVirtual(MultiblockTooltipBuilder.class, func, tp),
                    tp);
        ...
        if (Config.appendAddedBy) finisher(obj, LangManager.translateToLocal("programmable_hatches.addedby"));;
    }
    ...
    public static String[] get(String key, Map<String, Object> fmtter, boolean defaulted) {
        ...
        try (InputStream in = (defaulted ? getInputEN : getInput).apply(key)) {
            if (in == null) {
                if (defaulted) return new String[] { "!!! FATAL !!!", "en_US language file missing:" + key + ".lang",
            ...
            if (defaulted) {
                ...
                MyMod.LOG.fatal(
                    "Your current translation key:'programmable_hatches.gt.lang.dir' maps to:"
                        + LangManager.translateToLocal("programmable_hatches.gt.lang.dir"));
                MyMod.LOG.fatal(
                    "That means yous should put translated " + key
                        + ".lang in "
    ...
    static Function<String, InputStream> getInput = s -> Config.class.getResourceAsStream(
