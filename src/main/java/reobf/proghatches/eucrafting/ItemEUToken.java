        ...
        Optional.ofNullable(p_77624_1_.stackTagCompound)
            .ifPresent(s -> {
                Optional.of(ProghatchesUtil.deser(s, "EUFI"))
                    ...
                    .ifPresent(ss -> p_77624_3_.add("Host UUID:" + ss.toString()));
                if (p_77624_1_.stackSize == 0) p_77624_3_.add(s.getLong("voltage") + "V");// this is possible
                                                                                          // on crafting
                                                                                          // terminal
                else p_77624_3_.add(s.getLong("voltage") + "V, " + p_77624_1_.stackSize + "*1A");
