...
public class MASettings extends BaseSettingsPanel {
    ...
    public static class Holder {
        ...
        static public IWidgetIcon getMAIcon() {
            if (icon == null) icon = new IWidgetIcon() {
                ...
                public IWidgetMap getMap() {
                    ...
                    return new IWidgetMap.WidgetMapImpl(
                        16,
...

                    {
                        ...
                        @Override
                        public void render(IWidgetIcon widget, double x, double y, double width, double height,
                            double zLevel, boolean doDraw, boolean flipY) {
    ...
    public MASettings(GuiExternalConnection gui, IConduit con) {
        super(Holder.getMAIcon(), EnderIO.lang.localize("itemMEConduit.name"), gui, con);
    }
