	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		return new GuiDualInterface(player.inventory, host) {
			...
			public void initGui() {
				...
				rename = new GuiTabButton(this.guiLeft + 132, this.guiTop,
						AEApi.instance().items().itemCertusQuartzKnife.stack(1), "Rename" // StatCollector.translateToLocal("ae2fc.tooltip.switch_fluid_interface")
				, itemRender) {
