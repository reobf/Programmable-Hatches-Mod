...
public class ItemEmitterPattern extends DummySuper2 implements ICraftingPatternItem, IItemWithModularUI {
    ...
    public static class ItemEmitterPatternRenderer implements IItemRenderer {
        ...
        public boolean handleRenderType(final ItemStack item, final ItemRenderType type) {
            final boolean isShiftHeld = Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)
    ...
    public ICraftingPatternDetails getPatternForItem(ItemStack is, World w) {
        ...
        if (tag != null) {
            ...
            if (isx != null) return new EmitterPattern(
                is,
                AEItemStack.create(isx)
                    .setStackSize(tag.getLong("num")));
        }
    ...
    protected class UIFactory {
        ...
        protected void addUIWidgets(ModularWindow.Builder builder) {
            ...
            builder.widget(new TextFieldWidget().setGetter(() -> {
                if (getCurrentItem().getTagCompound() != null) {
                    return getCurrentItem().getTagCompound()
                        .getLong("num") + "";
                }
                ...
                .setSetter(val -> {
                    ...
                    getCurrentItem().getTagCompound()
                        .setLong("num", Long.valueOf(val));
            ...
            builder.widget(SlotWidget.phantom(new IItemHandlerModifiable() {
                ...
                public ItemStack insertItem(int var1, ItemStack var2, boolean var3) {
                    if (var2 != null && var2.getItem() instanceof ItemFluidPacket) {
                        ...
                        if (x != null) var2 = ItemFluidDrop.newStack(x);
                    }
                    ...
                    getCurrentItem().getTagCompound()
                        .setTag("out", one(var2.copy()).writeToNBT(new NBTTagCompound()));
                ...
                public void setStackInSlot(int var1, ItemStack var2) {
                    ...
                    if (var2 == null) getCurrentItem().getTagCompound()
                        .removeTag("out");
                    else getCurrentItem().getTagCompound()
                        .setTag("out", one(var2.copy()).writeToNBT(new NBTTagCompound()));
        ...
        public ItemStack one(ItemStack is) {
            is.stackSize = 1;
            return is;
        }
