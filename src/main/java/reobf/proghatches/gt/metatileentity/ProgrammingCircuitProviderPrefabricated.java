...
public class ProgrammingCircuitProviderPrefabricated extends MTEHatch implements ICircuitProvider {
    ...
    public ProgrammingCircuitProviderPrefabricated(int aID, String aName, String aNameRegional, int aTier,
        ...
        super(
            ...
            reobf.proghatches.main.Config.get(
                "PCPP",
                ImmutableMap.of("type", StatCollector.translateToLocal("circuitprovider.prefab." + i + ".type.name")
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        ...
        return new ProgrammingCircuitProviderPrefabricated(
            mName,
            mTier,
            mInventory.length,
            mDescriptionArray,
    ...
    static void init() {
        ...
        ItemList[][] all = new ItemList[][] { { Shape_Mold_Bottle, Shape_Mold_Plate, Shape_Mold_Ingot,
            ...
            Shape_Mold_Cylinder, Shape_Mold_Anvil, Shape_Mold_Arrow, Shape_Mold_Name, Shape_Mold_Rod, Shape_Mold_Bolt,
            Shape_Mold_Round, Shape_Mold_Screw, Shape_Mold_Ring, Shape_Mold_Rod_Long, Shape_Mold_Rotor,
            Shape_Mold_Turbine_Blade, Shape_Mold_Pipe_Tiny, Shape_Mold_Pipe_Small, Shape_Mold_Pipe_Medium,
            Shape_Mold_Pipe_Large, Shape_Mold_Pipe_Huge, Shape_Mold_ToolHeadDrill, },
            { Shape_Slicer_Flat, Shape_Slicer_Stripes, },
            { Shape_Extruder_Bottle, Shape_Extruder_Plate, Shape_Extruder_Cell, Shape_Extruder_Ring, Shape_Extruder_Rod,
                Shape_Extruder_Bolt, Shape_Extruder_Ingot, Shape_Extruder_Wire, Shape_Extruder_Casing,
                Shape_Extruder_Pipe_Tiny, Shape_Extruder_Pipe_Small, Shape_Extruder_Pipe_Medium,
                Shape_Extruder_Pipe_Large, Shape_Extruder_Pipe_Huge, Shape_Extruder_Block, Shape_Extruder_Sword,
                Shape_Extruder_Pickaxe, Shape_Extruder_Shovel, Shape_Extruder_Axe, Shape_Extruder_Hoe,
            ...
            { /*White_Dwarf_Shape_Extruder_Bottle, White_Dwarf_Shape_Extruder_Plate, White_Dwarf_Shape_Extruder_Cell,
                ...
                White_Dwarf_Shape_Extruder_Pipe_Medium, White_Dwarf_Shape_Extruder_Pipe_Large,
                White_Dwarf_Shape_Extruder_Pipe_Huge, White_Dwarf_Shape_Extruder_Block,
                White_Dwarf_Shape_Extruder_Sword, White_Dwarf_Shape_Extruder_Pickaxe, White_Dwarf_Shape_Extruder_Shovel,
        ...
        for (Werkstoff mat : Werkstoff.werkstoffHashSet) {
            ...
            if (opt != null && OreDictionary.getOreIDs(opt).length > 0) is.add(opt);
        }
        // System.out.println(is);System.out.println("TTTTTTTTTTTTT");
        reg(5, is);

        prefab.values()
            .forEach(s -> s.removeIf(isy -> {
