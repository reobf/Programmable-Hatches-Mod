        ...
        protected void addUIWidgets(ModularWindow.Builder builder) {
            ...
            if (getUIBuildContext().isAnotherWindow() == false) {
                ...
                builder.widget(new ButtonWidget().setOnClick((clickData, widget) -> {
                    ...
                    .setBackground(GTUITextures.BUTTON_STANDARD, PROBE)
                    .addTooltips(
                        ImmutableList
                    ...
                    .dynamicTooltip(
                        () -> c.getState() == 0
                            ? Arrays.asList(
                                ...
                                StatCollector.translateToLocal("programmable_hatches.cover.smart.dyn.shift.for.detail"))
                            : Arrays.asList(
                            ...
                            rangeOf(
                                Integer.valueOf(
                                    LangManager.translateToLocal(
                                        "programmable_hatches.cover.smart.dyn.shift." + c.getState()))).map(
